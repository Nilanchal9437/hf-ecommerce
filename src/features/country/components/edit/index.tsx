...
import update from "@/features/country/apis/update";
import getDetail from "@/features/country/apis/getDetail";
...
function Edit() {
  ...
  return (
    <Modal
      title="Edit Country"
      secondaryText="Update a country to use in company register"
      open={true}
      onClose={() => {
        router.back();
      }}
